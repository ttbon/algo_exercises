 ...
 */
public class OrderedInsert<Key extends Comparable<Key>, Value> {
     ...
     */
    public OrderedInsert(int capacity) {
    ...
    public void put(Key key, Value val)  {
        ...
        // optimize for ordered input -- THIS IS THE EDIT!
        if (this.isEmpty() || key.compareTo(this.max()) > 0){ //new key is greater than max
    ...
    /**
     * Unit tests the {@code OrderedInsert} data type.
     *
     * @param args the command-line arguments
     */
    public static void main(String[] args) {
        OrderedInsert<String, Integer> st = new OrderedInsert<String, Integer>();
